    ...
    return (
        <Card className="rounded-[1.5rem] border-slate-100 shadow-xl shadow-slate-200/50 bg-white/50 backdrop-blur-sm overflow-hidden flex flex-col h-[320px]">
                        ...
                        {activeOrders.length === 0 ? (
                            ...
                            activeOrders.map((order, idx) => (
                                <motion.div
                                    ...
                                    className="p-3 hover:bg-slate-50/80 transition-all cursor-pointer group"
                                >
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <div className="flex items-center gap-1.5 self-center">
                                            <div className="text-right">
                                                <p className="text-[11px] font-black text-slate-800 tracking-tighter line-clamp-1 max-w-[80px]">
            ...
            {activeOrders.length > 0 && (
                <div
                    onClick={() => navigate('/admin/orders')}
                    className="p-2.5 bg-slate-50/50 text-center border-t border-slate-100 hover:bg-indigo-50 transition-colors cursor-pointer group mt-auto"
                >
                    <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 group-hover:text-indigo-600">
                        View Console
                    </span>
                </div>
            )}
